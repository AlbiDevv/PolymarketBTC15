...
## Что было почищено перед публикацией

- README переписан на русском и без лишнего акцента на live-trading;
- сохранена модель работы через env-переменные без коммита секретов;
- из deploy-документации убраны персональные локальные пути.
